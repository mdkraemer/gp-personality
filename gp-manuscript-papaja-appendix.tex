...
(ref:H1-agree-tab-cap) Fixed Effects of Agreeableness Over the
Transition to Grandparenthood.

(ref:H1-agree-tab-note) Two models were computed for each of the two
...
\begin{TableNotes}[para]
\normalsize{\textit{Note.} (ref:H1-agree-tab-note)}
\end{TableNotes}

\footnotesize{

\begin{longtable}{lrcrrrcrr}\noalign{\getlongtablewidth\global\LTcapwidth=\longtablewidth}
\caption{\label{tab:H1-agree-tab}(ref:H1-agree-tab-cap)}\\
\toprule
...
(ref:H1-agree-gender-tab-cap) Fixed Effects of Agreeableness Over the
Transition to Grandparenthood Moderated by Gender.
(ref:H1-agree-gender-tab-note) Two models were computed for each of the
...
\begin{TableNotes}[para]
\normalsize{\textit{Note.} (ref:H1-agree-gender-tab-note)}
\end{TableNotes}

\footnotesize{

\begin{longtable}{lrcrrrcrr}\noalign{\getlongtablewidth\global\LTcapwidth=\longtablewidth}
\caption{\label{tab:H1-agree-gender-tab}(ref:H1-agree-gender-tab-cap)}\\
\toprule
 & \multicolumn{4}{c}{Parent controls} & \multicolumn{4}{c}{Nonparent controls} \\
\cmidrule(r){2-5} \cmidrule(r){6-9}
Parameter & $\hat{\gamma}$ & 95\% CI & $t$ & $p$ & $\hat{\gamma}$ & 95\% CI & $t$ & $p$\\
...
(ref:H1-con-tab-note) Two models were computed for each of the two
samples (LISS, HRS): grandparents matched with parent controls and with
nonparent controls. CI = confidence interval.
...
(ref:H1-con-care-tab-cap) Fixed Effects of Conscientiousness Over the
Transition to Grandparenthood Moderated by Grandchild Care.
(ref:H1-con-care-tab-note) Two models were computed (only HRS):
grandparents matched with parent controls and with nonparent controls.
CI = confidence interval. \(caring=1\) indicates more than 100 hours of
grandchild care since the last assessment.
...
\begin{TableNotes}[para]
\normalsize{\textit{Note.} (ref:H1-con-care-tab-note)}
\end{TableNotes}

\footnotesize{

\begin{longtable}{lrcrrrcrr}\noalign{\getlongtablewidth\global\LTcapwidth=\longtablewidth}
\caption{\label{tab:H1-con-care-tab}(ref:H1-con-care-tab-cap)}\\
\toprule
 & \multicolumn{4}{c}{Parent controls} & \multicolumn{4}{c}{Nonparent controls} \\
\cmidrule(r){2-5} \cmidrule(r){6-9}
Parameter & $\hat{\gamma}$ & 95\% CI & $t$ & $p$ & $\hat{\gamma}$ & 95\% CI & $t$ & $p$\\
...
(ref:H1-neur-tab-note) Two models were computed for each of the two
samples (LISS, HRS): grandparents matched with parent controls and with
nonparent controls. CI = confidence interval.
...
(ref:H3-rankorder-tab-note) Test-retest correlations as indicators of
...
(ref:H1-agree-restr-tab-cap) Fixed Effects of Agreeableness Over the
Transition to Grandparenthood in the Restricted Models.

(ref:H1-agree-restr-tab-note) Two models were computed for each of the
two samples (LISS, HRS): grandparents matched with parent controls and
...
\begin{TableNotes}[para]
\normalsize{\textit{Note.} (ref:H1-agree-restr-tab-note)}
\end{TableNotes}

\footnotesize{

\begin{longtable}{lrcrrrcrr}\noalign{\getlongtablewidth\global\LTcapwidth=\longtablewidth}
\caption{\label{tab:H1-agree-restr-tab}(ref:H1-agree-restr-tab-cap)}\\
\toprule
 & \multicolumn{4}{c}{Parent controls} & \multicolumn{4}{c}{Nonparent controls} \\
\cmidrule(r){2-5} \cmidrule(r){6-9}
Parameter & $\hat{\gamma}$ & 95\% CI & $t$ & $p$ & $\hat{\gamma}$ & 95\% CI & $t$ & $p$\\
...
(ref:H1-agree-gender-restr-tab-cap) Fixed Effects of Agreeableness Over
the Transition to Grandparenthood Moderated by Gender in the Restricted
Models.

(ref:H1-agree-gender-restr-tab-note) Two models were computed for each
...
\begin{TableNotes}[para]
\normalsize{\textit{Note.} (ref:H1-agree-gender-restr-tab-note)}
\end{TableNotes}

\footnotesize{

\begin{longtable}{lrcrrrcrr}\noalign{\getlongtablewidth\global\LTcapwidth=\longtablewidth}
\caption{\label{tab:H1-agree-gender-restr-tab}(ref:H1-agree-gender-restr-tab-cap)}\\
\toprule
 & \multicolumn{4}{c}{Parent controls} & \multicolumn{4}{c}{Nonparent controls} \\
\cmidrule(r){2-5} \cmidrule(r){6-9}
Parameter & $\hat{\gamma}$ & 95\% CI & $t$ & $p$ & $\hat{\gamma}$ & 95\% CI & $t$ & $p$\\
...
(ref:H1-con-restr-tab-cap) Fixed Effects of Conscientiousness Over the
Transition to Grandparenthood in the Restricted Models.

(ref:H1-con-restr-tab-note) Two models were computed for each of the two
samples (LISS, HRS): grandparents matched with parent controls and with
...
\begin{TableNotes}[para]
\normalsize{\textit{Note.} (ref:H1-con-restr-tab-note)}
\end{TableNotes}

\footnotesize{

\begin{longtable}{lrcrrrcrr}\noalign{\getlongtablewidth\global\LTcapwidth=\longtablewidth}
\caption{\label{tab:H1-con-restr-tab}(ref:H1-con-restr-tab-cap)}\\
\toprule
 & \multicolumn{4}{c}{Parent controls} & \multicolumn{4}{c}{Nonparent controls} \\
\cmidrule(r){2-5} \cmidrule(r){6-9}
Parameter & $\hat{\gamma}$ & 95\% CI & $t$ & $p$ & $\hat{\gamma}$ & 95\% CI & $t$ & $p$\\
...
(ref:H1-con-gender-restr-tab-cap) Fixed Effects of Conscientiousness
Over the Transition to Grandparenthood Moderated by Gender in the
Restricted Models.

(ref:H1-con-gender-restr-tab-note) Two models were computed for each of
...
\begin{TableNotes}[para]
\normalsize{\textit{Note.} (ref:H1-con-gender-restr-tab-note)}
\end{TableNotes}

\footnotesize{

\begin{longtable}{lrcrrrcrr}\noalign{\getlongtablewidth\global\LTcapwidth=\longtablewidth}
\caption{\label{tab:H1-con-gender-restr-tab}(ref:H1-con-gender-restr-tab-cap)}\\
\toprule
 & \multicolumn{4}{c}{Parent controls} & \multicolumn{4}{c}{Nonparent controls} \\
\cmidrule(r){2-5} \cmidrule(r){6-9}
Parameter & $\hat{\gamma}$ & 95\% CI & $t$ & $p$ & $\hat{\gamma}$ & 95\% CI & $t$ & $p$\\
...
(ref:H1-extra-restr-tab-cap) Fixed Effects of Extraversion Over the
Transition to Grandparenthood in the Restricted Models.

(ref:H1-extra-restr-tab-note) Two models were computed for each of the
two samples (LISS, HRS): grandparents matched with parent controls and
with nonparent controls. Analyses samples were restricted to \emph{time}
{[}-2, 6{]} and the \emph{before} coefficient recoded for the LISS
samples (0 at \emph{time}=-2 and 1 afterwards). CI = confidence
...
\begin{TableNotes}[para]
\normalsize{\textit{Note.} (ref:H1-extra-restr-tab-note)}
\end{TableNotes}

\footnotesize{

\begin{longtable}{lrcrrrcrr}\noalign{\getlongtablewidth\global\LTcapwidth=\longtablewidth}
\caption{\label{tab:H1-extra-restr-tab}(ref:H1-extra-restr-tab-cap)}\\
\toprule
 & \multicolumn{4}{c}{Parent controls} & \multicolumn{4}{c}{Nonparent controls} \\
\cmidrule(r){2-5} \cmidrule(r){6-9}
Parameter & $\hat{\gamma}$ & 95\% CI & $t$ & $p$ & $\hat{\gamma}$ & 95\% CI & $t$ & $p$\\
...
(ref:H1-extra-gender-restr-tab-cap) Fixed Effects of Extraversion Over
the Transition to Grandparenthood Moderated by Gender in the Restricted
Models.

(ref:H1-extra-gender-restr-tab-note) Two models were computed for each
of the two samples (LISS, HRS): grandparents matched with parent
controls and with nonparent controls. CI = confidence interval. Analyses
samples were restricted to \emph{time} {[}-2, 6{]} and the \emph{before}
coefficient recoded for the LISS samples (0 at \emph{time}=-2 and 1
...
\begin{TableNotes}[para]
\normalsize{\textit{Note.} (ref:H1-extra-gender-restr-tab-note)}
\end{TableNotes}

\footnotesize{

\begin{longtable}{lrcrrrcrr}\noalign{\getlongtablewidth\global\LTcapwidth=\longtablewidth}
\caption{\label{tab:H1-extra-gender-restr-tab}(ref:H1-extra-gender-restr-tab-cap)}\\
\toprule
 & \multicolumn{4}{c}{Parent controls} & \multicolumn{4}{c}{Nonparent controls} \\
\cmidrule(r){2-5} \cmidrule(r){6-9}
Parameter & $\hat{\gamma}$ & 95\% CI & $t$ & $p$ & $\hat{\gamma}$ & 95\% CI & $t$ & $p$\\
...
(ref:H1-neur-restr-tab-cap) Fixed Effects of Neuroticism Over the
Transition to Grandparenthood in the Restricted Models.

(ref:H1-neur-restr-tab-note) Two models were computed for each of the
two samples (LISS, HRS): grandparents matched with parent controls and
with nonparent controls. Analyses samples were restricted to \emph{time}
{[}-2, 6{]} and the \emph{before} coefficient recoded for the LISS
samples (0 at \emph{time}=-2 and 1 afterwards). CI = confidence
...
\begin{TableNotes}[para]
\normalsize{\textit{Note.} (ref:H1-neur-restr-tab-note)}
\end{TableNotes}

\footnotesize{

\begin{longtable}{lrcrrrcrr}\noalign{\getlongtablewidth\global\LTcapwidth=\longtablewidth}
\caption{\label{tab:H1-neur-restr-tab}(ref:H1-neur-restr-tab-cap)}\\
\toprule
 & \multicolumn{4}{c}{Parent controls} & \multicolumn{4}{c}{Nonparent controls} \\
\cmidrule(r){2-5} \cmidrule(r){6-9}
Parameter & $\hat{\gamma}$ & 95\% CI & $t$ & $p$ & $\hat{\gamma}$ & 95\% CI & $t$ & $p$\\
...
(ref:H1-neur-gender-restr-tab-cap) Fixed Effects of Neuroticism Over the
Transition to Grandparenthood Moderated by Gender in the Restricted
Models.

(ref:H1-neur-gender-restr-tab-note) Two models were computed for each of
the two samples (LISS, HRS): grandparents matched with parent controls
and with nonparent controls. CI = confidence interval. Analyses samples
were restricted to \emph{time} {[}-2, 6{]} and the \emph{before}
coefficient recoded for the LISS samples (0 at \emph{time}=-2 and 1
...
\begin{TableNotes}[para]
\normalsize{\textit{Note.} (ref:H1-neur-gender-restr-tab-note)}
\end{TableNotes}

\footnotesize{

\begin{longtable}{lrcrrrcrr}\noalign{\getlongtablewidth\global\LTcapwidth=\longtablewidth}
\caption{\label{tab:H1-neur-gender-restr-tab}(ref:H1-neur-gender-restr-tab-cap)}\\
\toprule
 & \multicolumn{4}{c}{Parent controls} & \multicolumn{4}{c}{Nonparent controls} \\
\cmidrule(r){2-5} \cmidrule(r){6-9}
Parameter & $\hat{\gamma}$ & 95\% CI & $t$ & $p$ & $\hat{\gamma}$ & 95\% CI & $t$ & $p$\\
...
(ref:H1-open-restr-tab-cap) Fixed Effects of Openness Over the
Transition to Grandparenthood in the Restricted Models.

(ref:H1-open-restr-tab-note) Two models were computed for each of the
two samples (LISS, HRS): grandparents matched with parent controls and
with nonparent controls. Analyses samples were restricted to \emph{time}
{[}-2, 6{]} and the \emph{before} coefficient recoded for the LISS
samples (0 at \emph{time}=-2 and 1 afterwards). CI = confidence
...
\begin{TableNotes}[para]
\normalsize{\textit{Note.} (ref:H1-open-restr-tab-note)}
\end{TableNotes}

\footnotesize{

\begin{longtable}{lrcrrrcrr}\noalign{\getlongtablewidth\global\LTcapwidth=\longtablewidth}
\caption{\label{tab:H1-open-restr-tab}(ref:H1-open-restr-tab-cap)}\\
\toprule
 & \multicolumn{4}{c}{Parent controls} & \multicolumn{4}{c}{Nonparent controls} \\
\cmidrule(r){2-5} \cmidrule(r){6-9}
Parameter & $\hat{\gamma}$ & 95\% CI & $t$ & $p$ & $\hat{\gamma}$ & 95\% CI & $t$ & $p$\\
...
(ref:H1-open-gender-restr-tab-cap) Fixed Effects of Openness Over the
Transition to Grandparenthood Moderated by Gender in the Restricted
Models.

(ref:H1-open-gender-restr-tab-note) Two models were computed for each of
the two samples (LISS, HRS): grandparents matched with parent controls
and with nonparent controls. CI = confidence interval. Analyses samples
were restricted to \emph{time} {[}-2, 6{]} and the \emph{before}
coefficient recoded for the LISS samples (0 at \emph{time}=-2 and 1
...
\begin{TableNotes}[para]
\normalsize{\textit{Note.} (ref:H1-open-gender-restr-tab-note)}
\end{TableNotes}

\footnotesize{

\begin{longtable}{lrcrrrcrr}\noalign{\getlongtablewidth\global\LTcapwidth=\longtablewidth}
\caption{\label{tab:H1-open-gender-restr-tab}(ref:H1-open-gender-restr-tab-cap)}\\
\toprule
 & \multicolumn{4}{c}{Parent controls} & \multicolumn{4}{c}{Nonparent controls} \\
\cmidrule(r){2-5} \cmidrule(r){6-9}
Parameter & $\hat{\gamma}$ & 95\% CI & $t$ & $p$ & $\hat{\gamma}$ & 95\% CI & $t$ & $p$\\
...
(ref:H1-swls-restr-tab-cap) Fixed Effects of Life Satisfaction Over the
Transition to Grandparenthood in the Restricted Models.

(ref:H1-swls-restr-tab-note) Two models were computed for each of the
two samples (LISS, HRS): grandparents matched with parent controls and
with nonparent controls. Analyses samples were restricted to \emph{time}
{[}-2, 6{]} and the \emph{before} coefficient recoded for the LISS
samples (0 at \emph{time}=-2 and 1 afterwards). CI = confidence
...
\begin{TableNotes}[para]
\normalsize{\textit{Note.} (ref:H1-swls-restr-tab-note)}
\end{TableNotes}

\footnotesize{

\begin{longtable}{lrcrrrcrr}\noalign{\getlongtablewidth\global\LTcapwidth=\longtablewidth}
\caption{\label{tab:H1-swls-restr-tab}(ref:H1-swls-restr-tab-cap)}\\
\toprule
 & \multicolumn{4}{c}{Parent controls} & \multicolumn{4}{c}{Nonparent controls} \\
\cmidrule(r){2-5} \cmidrule(r){6-9}
Parameter & $\hat{\gamma}$ & 95\% CI & $t$ & $p$ & $\hat{\gamma}$ & 95\% CI & $t$ & $p$\\
...
(ref:H1-swls-gender-restr-tab-cap) Fixed Effects of Life Satisfaction
Over the Transition to Grandparenthood Moderated by Gender in the
Restricted Models.

(ref:H1-swls-gender-restr-tab-note) Two models were computed for each of
the two samples (LISS, HRS): grandparents matched with parent controls
and with nonparent controls. CI = confidence interval. Analyses samples
were restricted to \emph{time} {[}-2, 6{]} and the \emph{before}
coefficient recoded for the LISS samples (0 at \emph{time}=-2 and 1
...
\begin{TableNotes}[para]
\normalsize{\textit{Note.} (ref:H1-swls-gender-restr-tab-note)}
\end{TableNotes}

\footnotesize{

\begin{longtable}{lrcrrrcrr}\noalign{\getlongtablewidth\global\LTcapwidth=\longtablewidth}
\caption{\label{tab:H1-swls-gender-restr-tab}(ref:H1-swls-gender-restr-tab-cap)}\\
\toprule
 & \multicolumn{4}{c}{Parent controls} & \multicolumn{4}{c}{Nonparent controls} \\
\cmidrule(r){2-5} \cmidrule(r){6-9}
Parameter & $\hat{\gamma}$ & 95\% CI & $t$ & $p$ & $\hat{\gamma}$ & 95\% CI & $t$ & $p$\\
...
(ref:flowchart-fig-cap) Participant flowchart demonstrating the
composition of the four analysis samples via matching (1:4 matching
ratio with replacement). obs. = longitudinal observations.
...
\caption{(ref:flowchart-fig-cap)}(\#fig:flowchart-participant)
\end{figure}
...
(ref:H1-agree-fig-cap) Change trajectories of agreeableness based on the
...
\caption{(\#fig:H1-agree-fig)(ref:H1-agree-fig-cap)}
\end{figure}
...
(ref:H1-con-care-fig-cap) Change trajectories of conscientiousness based
on the models of moderation by grandchild care (see Table
...
\caption{(\#fig:H1-con-care-fig)(ref:H1-con-care-fig-cap)}
\end{figure}
...
(ref:effects-basic-plot-cap) Unstandardized Effect Sizes of the Basic
...
\caption{(\#fig:effects-basic-plot)(ref:effects-basic-plot-cap)}
\end{figure}

(ref:effects-gender-plot-cap) Unstandardized Effect Sizes of the Models
...
\caption{(\#fig:effects-gender-plot)(ref:effects-gender-plot-cap)}
\end{figure}

(ref:H1-agree-restr-fig-cap) Change trajectories of agreeableness based
on the \emph{restricted} (time {[}-2, 6{]}) basic models (left column)
and the models including the gender interaction (right column). The
error bars are 95\% confidence intervals of the predicted values which
only account for the fixed-effects portion of the model. The vertical
line indicates the approximate time of the transition to
grandparenthood.

\begin{figure}
\centering
\includegraphics{Figs/H1-agree-restr-fig-1.pdf}
\caption{(\#fig:H1-agree-restr-fig)(ref:H1-agree-restr-fig-cap)}
\end{figure}

(ref:H1-con-restr-fig-cap) Change trajectories of conscientiousness
based on the \emph{restricted} (time {[}-2, 6{]}) basic models (left
column) and the models including the gender interaction (right column).
The error bars are 95\% confidence intervals of the predicted values
which only account for the fixed-effects portion of the model. The
vertical line indicates the approximate time of the transition to
grandparenthood.

\begin{figure}
\centering
\includegraphics{Figs/H1-con-restr-fig-1.pdf}
\caption{(\#fig:H1-con-restr-fig)(ref:H1-con-restr-fig-cap)}
\end{figure}

(ref:H1-extra-restr-fig-cap) Change trajectories of extraversion based
on the \emph{restricted} (time {[}-2, 6{]}) basic models (left column)
and the models including the gender interaction (right column). The
error bars are 95\% confidence intervals of the predicted values which
only account for the fixed-effects portion of the model. The vertical
...
\begin{figure}
\centering
\includegraphics{Figs/H1-extra-restr-fig-1.pdf}
\caption{(\#fig:H1-extra-restr-fig)(ref:H1-extra-restr-fig-cap)}
\end{figure}

(ref:H1-neur-restr-fig-cap) Change trajectories of neuroticism based on
the \emph{restricted} (time {[}-2, 6{]}) basic models (left column) and
the models including the gender interaction (right column). The error
bars are 95\% confidence intervals of the predicted values which only
account for the fixed-effects portion of the model. The vertical line
indicates the approximate time of the transition to grandparenthood.

\begin{figure}
\centering
\includegraphics{Figs/H1-neur-restr-fig-1.pdf}
\caption{(\#fig:H1-neur-restr-fig)(ref:H1-neur-restr-fig-cap)}
\end{figure}

(ref:H1-open-restr-fig-cap) Change trajectories of openness based on the
\emph{restricted} (time {[}-2, 6{]}) basic models (left column) and the
models including the gender interaction (right column). The error bars
are 95\% confidence intervals of the predicted values which only account
for the fixed-effects portion of the model. The vertical line indicates
the approximate time of the transition to grandparenthood.

\begin{figure}
\centering
\includegraphics{Figs/H1-open-restr-fig-1.pdf}
\caption{(\#fig:H1-open-restr-fig)(ref:H1-open-restr-fig-cap)}
\end{figure}

(ref:H1-swls-restr-fig-cap) Change trajectories of life satisfaction
based on the \emph{restricted} (time {[}-2, 6{]}) basic models (left
column) and the models including the gender interaction (right column).
The error bars are 95\% confidence intervals of the predicted values
which only account for the fixed-effects portion of the model. The
...
\begin{figure}
\centering
\includegraphics{Figs/H1-swls-restr-fig-1.pdf}
\caption{(\#fig:H1-swls-restr-fig)(ref:H1-swls-restr-fig-cap)}
\end{figure}
