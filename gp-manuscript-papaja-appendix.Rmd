...
(ref:piecewise-coding-scheme-note) obs. = observations. $time=0$ marks the first year where the transition to grandparenthood has been reported. The number of participants is $N_{LISS}=$ 250 and $N_{HRS}=$ 846. 
