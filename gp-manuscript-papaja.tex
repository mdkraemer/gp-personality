...
Means and standard deviations of the Big Five and life satisfaction over the analyzed time points are presented in Tables \ref{tab:descriptives-liss} and \ref{tab:descriptives-hrs}. In both the LISS and the HRS, all six outcomes display marked stability over time. Standard deviations for life satisfaction are considerably larger than those of the Big Five. Intra-class correlations (see Table \ref{tab:icc-table}) show that for the Big Five large portions of the total variance could be explained by nesting in participants (\emph{median} = 0.75), while nesting in households only accounted for minor portions (\emph{median} = 0.03). For outcome--subsample combinations with an \(ICC_{hid}\) below \(.05\) we omitted the household nesting factor from all models because this frequently lead to computational errors---a small deviation from our preregistration. For life satisfaction the nesting in households accounted for slightly larger portions of the total variance (\emph{median} = 0.36) than nesting in participants (\emph{median} = 0.32). For all outcomes, the proportion of variance due to within-person factors was relatively low (\emph{median} = 0.22).
...
\item
  ...
  -\textgreater{} follow-up: latent class analysis / mixture models
\item
...
\caption{\label{fig:loess-agree}Violin Plots and LOESS Line of Agreeableness.}
\end{figure}
...
\caption{\label{fig:loess-con}Violin Plots and LOESS Line of Conscientiousness.}
\end{figure}
...
\caption{\label{fig:loess-extra}Violin Plots and LOESS Line of Extraversion.}
\end{figure}
...
\caption{\label{fig:loess-neur}Violin Plots and LOESS Line of Neuroticism.}
\end{figure}
...
\caption{\label{fig:loess-open}Violin Plots and LOESS Line of Openness.}
\end{figure}
...
\caption{\label{fig:loess-swls}Violin Plots and LOESS Line of Life Satisfaction.}
\end{figure}
