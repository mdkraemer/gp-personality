...
meaningfulness of small effects in psychology (Götz et al., 2021)

agreeableness: compare with literature on generativity (Erikson)

strength: internal cross-study replication

grandchild care as possible protective factor agaisnt loneliness in COVID-19 pandemic (Quirke et al., 2020)
...
\item
  ...
  --\textgreater{} maybe not life transitions but health declines largely responsible for personality development in old age (some evidence for rank-order stability: (Seifert et al., 2021))
\end{itemize}
...
\leavevmode\hypertarget{ref-quirkeExtendingUnderstandingGrandchild2020}{}%
Quirke, E., König, H.-H., \& Hajek, A. (2020). Extending understanding of grandchild care on feelings of loneliness and isolation in later life. \emph{Zeitschrift Für Gerontologie Und Geriatrie}. \url{https://doi.org/10.1007/s00391-020-01776-5}
