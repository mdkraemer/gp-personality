...
Despite these strengths, a number of limitations also need to be addressed: First, . Second, we only relied on self-report data and not on any other-reports by family members or close friends ({\textbf{???}}; Luan et al., 2017; McCrae, 2018; McCrae \& Mõttus, 2019). Thus our results might be influenced by common method bias (Podsakoff et al., 2003).
...
\item
  ...
  -\textgreater{} also historical context!
\item
