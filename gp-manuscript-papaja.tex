...
\noindent
accounts. We deviate from the preregistration in using new waves of data released in the meantime (2020/2021 LISS) as well as updated datasets (HRS). Following Benjamin et al.~(2018), we set the \(\alpha\)-level for confirmatory analyses to \(.005\).
