...
for (i in 1:length(outcomes)){
  for (j in 1:length(datasets_short)){
    ...
    for (k in 1:length(to_be_tested)){
      ...
      contrast["p_print"] <- # remove "0" from the chr
        lapply(contrast["p_print"], gsub, pattern="0\\.", replacement="\\.")
      contrast <- contrast %>% 
        unite(all, c(est_num, chi_print, p_print), sep = ", ", remove = F) # combined string
...
gamma_comb_work <- gamma_comb_gender # the same (for now)
...
gamma_comb_care <- c("($\\hat{\\gamma}_{11}$ + $\\hat{\\gamma}_{13}$)",
                     "($\\hat{\\gamma}_{12}$ + $\\hat{\\gamma}_{13}$)")
...
In the basic models (see Tables \@ref(tab:H1-agree-tab) & \@ref(tab:H1-agree-contrasts) and Figure \@ref(fig:H1-agree-fig)), grandparents in the LISS sample slightly increase in agreeableness in the years after the transition to grandparenthood as compared to the parent controls, `r agree_liss_parents_summary$full_result$after_grandparent`, `r agree_liss_parents_p["after:grandparent",]`. However, this effect is very small in magnitude and not significant when compared against the nonparent controls, or against either control sample in the HRS sample (suggestive evidence in the HRS nonparents: `r agree_hrs_nonparents_summary$full_result$after_grandparent`, `r agree_hrs_nonparents_p["after:grandparent",]`). The models including the gender interaction (see Tables \@ref(tab:H1-agree-gender-tab) & \@ref(tab:H1-agree-gender-contrasts) and Figure \@ref(fig:H1-agree-fig)) suggests that this difference is due to grandfathers' post-transition increases in agreeableness as compared to parent (LISS: `r agree_liss_parents_gender_summary$full_result$after_grandparent`, `r agree_liss_parents_gender_p["after:grandparent",]`; HRS: `r agree_hrs_parents_gender_summary$full_result$after_grandparent`, `r agree_hrs_parents_gender_p["after:grandparent",]`) and nonparent controls (only HRS: `r agree_hrs_nonparents_gender_summary$full_result$after_grandparent`, `r agree_hrs_nonparents_gender_p["after:grandparent",]`).  
There is only suggestive evidence for a moderation by paid work (see Tables \@ref(tab:H1-agree-work-tab) & \@ref(tab:H1-agree-work-contrasts) and Figure \@ref(fig:H1-agree-work-fig)): non-working grandparents increase more in agreeableness than working grandparents in anticipation of the transition to grandparenthood [parents: `r contrasts_work_agree$hrs_parents["before_nowork_vs_work_gp", "all"]`; nonparents: `r contrasts_work_agree$hrs_nonparents["before_nowork_vs_work_gp", "all"]`]. Grandparents providing substantial grandchild care increased in agreeableness after the transition to grandparenthood as compared to matched nonparent controls, `r contrasts_care_agree$hrs_nonparents["after_gp_vs_control_care", "all"]` [suggestive evidence when compared to the parent controls: `r contrasts_care_agree$hrs_parents["after_gp_vs_control_care", "all"]`; see  Tables \@ref(tab:H1-agree-care-tab) & \@ref(tab:H1-agree-care-contrasts) and Figure \@ref(fig:H1-agree-care-fig)].  

### Conscientiousness

For conscientiousness (see Tables \@ref(tab:H1-con-tab) & \@ref(tab:H1-con-contrasts) and Figure \@ref(fig:H1-con-fig)), there is evidence for a slight post-transition increase in the grandparents as compared to the controls in the HRS (parents: `r con_hrs_parents_summary$full_result$after_grandparent`, `r con_hrs_parents_p["after:grandparent",]`; nonparents: `r con_hrs_nonparents_summary$full_result$after_grandparent`, `r con_hrs_nonparents_p["after:grandparent",]`; suggestive evidence in the LISS parent sample: `r con_liss_parents_summary$full_result$after_grandparent`, `r con_liss_parents_p["after:grandparent",]`). Effects for conscientiousness were not moderated by gender (see Tables \@ref(tab:H1-con-gender-tab) & \@ref(tab:H1-con-gender-contrasts) and Figure \@ref(fig:H1-con-fig)).  
However, there were significant differences depending on grandparents' work status (see Tables \@ref(tab:H1-con-work-tab) & \@ref(tab:H1-con-work-contrasts) and Figure \@ref(fig:H1-con-work-fig)): non-working grandparents saw more pronounced increases in conscientiousness in the years before the transition to grandparenthood compared to non-working parent, `r con_hrs_parents_work_summary$full_result$before_grandparent`, `r con_hrs_parents_work_p["before:grandparent",]`, and nonparent controls, `r con_hrs_nonparents_work_summary$full_result$before_grandparent`, `r con_hrs_nonparents_work_p["before:grandparent",]`, and compared to working grandparents [parents: `r contrasts_work_con$hrs_parents["before_nowork_vs_work_gp", "all"]`; nonparents: `r contrasts_work_con$hrs_nonparents["before_nowork_vs_work_gp", "all"]`]. There is suggestive evidence that grandparents who provide substantial grandchild care increase more strongly in conscientiousness after the transition compared to grandparents who do not [parents: `r contrasts_care_con$hrs_parents["after_nocare_vs_care_gp", "all"]`; nonparents: `r contrasts_care_con$hrs_nonparents["after_nocare_vs_care_gp", "all"]`, see Tables \@ref(tab:H1-con-care-tab) & \@ref(tab:H1-con-care-contrasts) and Figure \@ref(fig:H1-con-care-fig)].

### Extraversion

The trajectories of grandparents' extraversion closely follow those of the matched controls. There are no significant effects indicating differences between grandparents and controls in the basic models (see Tables \@ref(tab:H1-extra-tab) & \@ref(tab:H1-extra-contrasts) and Figure \@ref(fig:H1-extra-fig)), the models including the gender interaction (see Tables \@ref(tab:H1-extra-gender-tab) & \@ref(tab:H1-extra-gender-contrasts) and Figure \@ref(fig:H1-extra-fig)), or the models of moderation by paid work (see Tables \@ref(tab:H1-extra-work-tab) & \@ref(tab:H1-extra-work-contrasts) and Figure \@ref(fig:H1-extra-work-fig)). In the analysis of moderation by grandchild care (see Tables \@ref(tab:H1-extra-care-tab) & \@ref(tab:H1-extra-care-contrasts) and Figure \@ref(fig:H1-extra-care-fig)) it can be seen that compared to matched parent controls caring grandparents increase slightly more strongly in extraversion after the transition to grandparenthood, `r contrasts_care_extra$hrs_parents["after_gp_vs_control_care", "all"]` [suggestive evidence in the nonparent sample: `r contrasts_care_extra$hrs_nonparents["after_gp_vs_control_care", "all"]`].

### Neuroticism

The basic models for neuroticism (see Tables \@ref(tab:H1-neur-tab) & \@ref(tab:H1-neur-contrasts) and Figure \@ref(fig:H1-neur-fig)) only show minor differences between grandparents and matched controls. Compared to the parent controls, grandparents in the HRS shifted slightly downward in their neuroticism immediately after the transition to grandparenthood, `r contrasts_neur$hrs_parents["shift_gp_vs_control", "all"]`. However, this was not the case in the three other samples (HRS nonparents, LISS parents, and LISS nonparents). Further, in the HRS there is suggestive evidence that grandparents increase in neuroticism before the transition to grandparenthood compared to the nonparent controls, `r neur_hrs_nonparents_summary$full_result$before_grandparent`, `r neur_hrs_nonparents_p["before:grandparent",]`. The models including the gender interaction (see Tables \@ref(tab:H1-neur-gender-tab) & \@ref(tab:H1-neur-gender-contrasts) and Figure \@ref(fig:H1-neur-fig)) only show one significant effect in the comparison of grandparents and controls: In the HRS, grandfathers, as compared to male parent controls, shift downwards in neuroticism in the year immediately after the transition to grandparenthood, `r contrasts_gender_neur$hrs_parents["shift_gp_vs_control_men", "all"]` [suggestive evidence in the HRS nonparent sample: `r contrasts_gender_neur$hrs_nonparents["shift_gp_vs_control_men", "all"]`]. There is also suggestive evidence that grandfathers in the HRS increase more strongly in neuroticism before the transition than the controls (parent controls: `r neur_hrs_parents_gender_summary$full_result$before_grandparent`, `r neur_hrs_parents_gender_p["before:grandparent",]`; nonparent controls: `r neur_hrs_nonparents_gender_summary$full_result$before_grandparent`, `r neur_hrs_nonparents_gender_p["before:grandparent",]`).  
Grandparents' trajectories of neuroticism as compared to the controls were significantly moderated by paid work (see Tables \@ref(tab:H1-neur-work-tab) & \@ref(tab:H1-neur-work-contrasts) and Figure \@ref(fig:H1-neur-work-fig)): Compared to working nonparent controls, working grandparents increase more strongly in neuroticism in the years before the transition to grandparenthood, `r contrasts_work_neur$hrs_nonparents["before_gp_vs_control_work", "all"]` [suggestive evidence in the parent sample `r contrasts_work_neur$hrs_parents["before_gp_vs_control_work", "all"]`]. At the first assessment post-transition, working grandparents decrease more strongly in neuroticism compared to working parent controls, `r contrasts_work_neur$hrs_parents["shift_gp_vs_control_work", "all"]` [suggestive evidence in the nonparent sample `r contrasts_work_neur$hrs_nonparents["shift_gp_vs_control_work", "all"]`]. There is suggestive evidence that grandparents providing substantial grandchild care decrease more strongly in neuroticism after the transition to grandparenthood than grandparents who do not [parents: `r contrasts_care_neur$hrs_parents["after_nocare_vs_care_gp", "all"]`; nonparents: `r contrasts_care_neur$hrs_nonparents["after_nocare_vs_care_gp", "all"]`, see Tables \@ref(tab:H1-neur-care-tab) & \@ref(tab:H1-neur-care-contrasts) and Figure \@ref(fig:H1-neur-care-fig)].  

### Openness

For openness there is also a high degree of similarity between the grandparents and the matched control subjects in the basic (see Tables \@ref(tab:H1-open-tab) & \@ref(tab:H1-open-contrasts) and Figure \@ref(fig:H1-open-fig)) and gender interactions models (see Tables \@ref(tab:H1-open-gender-tab) & \@ref(tab:H1-open-gender-contrasts) and Figure \@ref(fig:H1-open-fig)). Grandparents in the HRS decreased in openness in the first assessment after the transition to grandparenthood compared to the parent controls, `r contrasts_open$hrs_parents["shift_gp_vs_control", "all"]` [suggestive evidence in the nonparent sample: `r contrasts_open$hrs_nonparents["shift_gp_vs_control", "all"]`]. This effect is due to significant differences between grandfathers and male parent controls in the shift immediately after the transition, `r contrasts_gender_open$hrs_parents["shift_gp_vs_control_men", "all"]`. There is suggestive evidence that grandmothers in the LISS increase more strongly in openness before the transition to grandparenthood than female controls [parents: `r contrasts_gender_open$liss_parents["before_gp_vs_control_women", "all"]`; nonparents: `r contrasts_gender_open$liss_nonparents["before_gp_vs_control_women", "all"]`].  
Performing paid work moderated grandparents' trajectories in subtle ways (see Tables \@ref(tab:H1-open-work-tab) & \@ref(tab:H1-open-work-contrasts) and Figure \@ref(fig:H1-open-work-fig)): Non-working grandparents increased more strongly in openness post-transition than non-working controls (parents: `r open_hrs_parents_work_summary$full_result$after_grandparent`, `r open_hrs_parents_work_p["after:grandparent",]`; nonparents: `r open_hrs_nonparents_work_summary$full_result$after_grandparent`, `r open_hrs_nonparents_work_p["after:grandparent",]`). Further, there is suggestive evidence that openness of non-working grandparents decreased compared to non-working controls directly after the transition [parents: `r contrasts_work_open$hrs_parents["shift_gp_vs_control_nowork", "all"]`; nonparents: `r contrasts_work_open$hrs_nonparents["shift_gp_vs_control_nowork", "all"]`], and that---compared to non-working grandparents---working grandparents increased in openness directly after the transition [parents: `r contrasts_work_open$hrs_parents["shift_nowork_vs_work_gp", "all"]`; nonparents: `r contrasts_work_open$hrs_nonparents["shift_nowork_vs_work_gp", "all"]`] and decreased afterwards [parents: `r contrasts_work_open$hrs_parents["after_nowork_vs_work_gp", "all"]`; nonparents: `r contrasts_work_open$hrs_nonparents["after_nowork_vs_work_gp", "all"]`]. The analysis of moderation by grandchild care (see Tables \@ref(tab:H1-open-care-tab) & \@ref(tab:H1-open-care-contrasts) and Figure \@ref(fig:H1-open-care-fig)) reveals that grandparents providing substantial grandchild care increased more strongly in openness after the transition to grandparenthood than their matched nonparent controls, `r contrasts_care_open$hrs_nonparents["after_gp_vs_control_care", "all"]` (`r contrasts_care_open$hrs_parents["after_gp_vs_control_care", "all"]`). 

### Life Satisfaction

The basic model for life satisfaction (see Tables \@ref(tab:H1-swls-tab) & \@ref(tab:H1-swls-contrasts) and Figure \@ref(fig:H1-swls-fig)) provides suggestive evidence that grandparents in the HRS increased more strongly in their life satisfaction before the transition to grandparenthood than matched parent controls, `r swls_hrs_parents_summary$full_result$before_grandparent`, `r swls_hrs_parents_p["before:grandparent",]`. Grandparents in the LISS increased more strongly in life satisfaction directly after the transition compared to the nonparent controls, `r contrasts_swls$liss_nonparents["shift_gp_vs_control", "all"]`. There is evidence in the models including the gender interaction (see Tables \@ref(tab:H1-swls-gender-tab) & \@ref(tab:H1-swls-gender-contrasts) and Figure \@ref(fig:H1-swls-fig)) that grandmothers in the LISS increased more strongly in life satisfaction directly post-transition than female nonparent controls `r contrasts_gender_swls$liss_nonparents["shift_gp_vs_control_women", "all"]`. Further, grandmothers in the HRS increased in life satisfaction before the transition to grandparenthood compared to female parent controls `r contrasts_gender_swls$hrs_parents["before_gp_vs_control_women", "all"]`. The models of the moderation by paid work give suggestive evidence that working grandparents increase in life satisfaction before the transition to grandparenthood compared to working parent controls, `r contrasts_work_swls$hrs_parents["before_gp_vs_control_work", "all"]` (see Tables \@ref(tab:H1-swls-work-tab) & \@ref(tab:H1-swls-work-contrasts) and Figure \@ref(fig:H1-swls-work-fig)). There is no evidence for a moderation by grandchild care (see Tables \@ref(tab:H1-swls-care-tab) & \@ref(tab:H1-swls-care-contrasts) and Figure \@ref(fig:H1-swls-care-fig)).  
