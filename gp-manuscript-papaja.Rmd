...
# This chunk runs 4*4=16 models, 4 four each ...
...
```{r H1-build-plots, include=FALSE}
...
apa_table(
  ...
  , stub_indents = list("LISS panel (M1a, M1b)" = 1:9, "HRS (M2a, M2b)" = 10:18)
  , placement = "H"
)
```

(ref:H1-agree-gender-tab-cap) Fixed Effects of Agreeableness Over the Transition to Grandparenthood Moderated by Gender.
...
apa_table(
  ...
  , landscape = T
  , font_size = "footnotesize"
  , stub_indents = list("LISS panel (M1a, M1b)" = 1:17, "HRS (M2a, M2b)" = 18:34)
  , placement = "H"
)
```

(ref:H1-con-tab-cap) Fixed Effects of Conscientiousness Over the Transition to Grandparenthood.
...
(ref:H1-con-gender-tab-cap) Fixed Effects of Conscientiousness Over the Transition to Grandparenthood Moderated by Gender.
...
(ref:H1-extra-tab-cap) Fixed Effects of Extraversion Over the Transition to Grandparenthood.
...
(ref:H1-extra-gender-tab-cap) Fixed Effects of Extraversion Over the Transition to Grandparenthood Moderated by Gender.
...
(ref:H1-neur-tab-cap) Fixed Effects of Neuroticism Over the Transition to Grandparenthood.
...
(ref:H1-neur-gender-tab-cap) Fixed Effects of Neuroticism Over the Transition to Grandparenthood Moderated by Gender.
...
(ref:H1-open-tab-cap) Fixed Effects of Openness to Experience Over the Transition to Grandparenthood.
...
(ref:H1-open-gender-tab-cap) Fixed Effects of Openness to Experience Over the Transition to Grandparenthood Moderated by Gender.
...
(ref:H1-swls-tab-cap) Fixed Effects of Life Satisfaction Over the Transition to Grandparenthood.
...
(ref:H1-swls-gender-tab-cap) Fixed Effects of Life Satisfaction Over the Transition to Grandparenthood Moderated by Gender.
...
(ref:H1-agree-fig-cap) Change trajectories of agreeableness based on the basic models (1st column) and the models with the gender interaction (2nd column). The error bars are 95% confidence intervals of the predicted values which only account for the fixed-effects portion of the model. The vertical line indicates the approximate time of the transition to grandparenthood.

```{r H1-agree-fig, fig.cap = "(ref:H1-agree-fig-cap)", fig.height=9, fig.width=7}
# extract the legends
...
(ref:H1-con-fig-cap) Change trajectories of conscientiousness based on the basic models (1st column) and the models with the gender interaction (2nd column). The error bars are 95% confidence intervals of the predicted values which only account for the fixed-effects portion of the model. The vertical line indicates the approximate time of the transition to grandparenthood.

```{r H1-con-fig, fig.cap = "(ref:H1-con-fig-cap)", fig.height=9, fig.width=7}
# extract the legends
...
(ref:H1-extra-fig-cap) Change trajectories of extraversion based on the basic models (1st column) and the models with the gender interaction (2nd column). The error bars are 95% confidence intervals of the predicted values which only account for the fixed-effects portion of the model. The vertical line indicates the approximate time of the transition to grandparenthood.

```{r H1-extra-fig, fig.cap = "(ref:H1-extra-fig-cap)", fig.height=9, fig.width=7}
# extract the legends
...
(ref:H1-neur-fig-cap) Change trajectories of neuroticism based on the basic models (1st column) and the models with the gender interaction (2nd column). The error bars are 95% confidence intervals of the predicted values which only account for the fixed-effects portion of the model. The vertical line indicates the approximate time of the transition to grandparenthood.

```{r H1-neur-fig, fig.cap = "(ref:H1-neur-fig-cap)", fig.height=9, fig.width=7}
# extract the legends
...
(ref:H1-open-fig-cap) Change trajectories of openness based on the basic models (1st column) and the models with the gender interaction (2nd column). The error bars are 95% confidence intervals of the predicted values which only account for the fixed-effects portion of the model. The vertical line indicates the approximate time of the transition to grandparenthood.

```{r H1-open-fig, fig.cap = "(ref:H1-open-fig-cap)", fig.height=9, fig.width=7}
# extract the legends
...
(ref:H1-swls-fig-cap) Change trajectories of life satisfaction based on the basic models (1st column) and the models with the gender interaction (2nd column). The error bars are 95% confidence intervals of the predicted values which only account for the fixed-effects portion of the model. The vertical line indicates the approximate time of the transition to grandparenthood.

```{r H1-swls-fig, fig.cap = "(ref:H1-swls-fig-cap)", fig.height=9, fig.width=7}
# extract the legends
