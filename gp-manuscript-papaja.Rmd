...
for (i in 1:length(outcomes)){
  ...
  for (j in 1:length(datasets)){
    ...
    pred_gender <- cbind(subset(get(dataset), !is.na(get(outcome)), select = c(pid, time, get(outcome))), 
                         pred_outcome = predict(model_3, re.form=NA)) # model outcome values (gender)
...
gammas_work <- c("gamma}_{00", "gamma}_{04", "gamma}_{10", "gamma}_{20", "gamma}_{30", "gamma}_{01", 
                   "gamma}_{02", "gamma}_{11", "gamma}_{21", "gamma}_{31",
                   "gamma}_{12", "gamma}_{22", "gamma}_{32", "gamma}_{03", 
                   "gamma}_{13", "gamma}_{23", "gamma}_{33")
...
for (i in 1:length(outcomes)){
  ...
  for (j in 1:length(datasets_care)){
    ...
    r2_care_name <- paste0("r2_", outcome, "_", dataset) # data set name already includes '_care'
...
for (i in 1:length(dframes_hrs)){
  ...
  if (dframes_hrs[i] %in% dframes_hrs[grep("^(?=.*_parents_)", dframes_hrs, perl=T)]){ 
...
# construct data sets with the last pre- and the first post-transition assessment (within-person)
...
(ref:H1-agree-tab-note) Two models were computed for each of the two samples (LISS, HRS): grandparents matched with parent controls (models MXa) and with nonparent controls (models MXb). CI = confidence interval. $R^2_{M1a} =$ `r printnum(r2_agree_lissanalysis_parents)`, $R^2_{M1b} =$ `r printnum(r2_agree_lissanalysis_nonparents)`, $R^2_{M2a} =$ `r printnum(r2_agree_hrsanalysis_parents)`, $R^2_{M2b} =$ `r printnum(r2_agree_hrsanalysis_nonparents)`.
...
apa_table(
  ...
  , stub_indents = list("LISS (M1a, M1b)" = 1:9, "HRS (M2a, M2b)" = 10:18)
  , placement = "H"
)
```

(ref:H1-agree-contrasts-cap) Linear Contrasts for `r df_outcomes["agree", "maj"]`.
(ref:H1-agree-contrasts-note) The linear contrasts are needed in cases where estimates of interest are represented by multiple fixed-effects coefficients and are computed using the *linearHypothesis* function from the *car* R package [@car2019] based on the models from Table \@ref(tab:H1-agree-tab).
...
(ref:H1-agree-gender-tab-note) Two models were computed for each of the two samples (LISS, HRS): grandparents matched with parent controls (models MXa) and with nonparent controls (models MXb). CI = confidence interval. $R^2_{M1a} =$ `r printnum(r2_agree_lissanalysis_parents_gender)`, $R^2_{M1b} =$ `r printnum(r2_agree_lissanalysis_nonparents_gender)`, $R^2_{M2a} =$ `r printnum(r2_agree_hrsanalysis_parents_gender)`, $R^2_{M2b} =$ `r printnum(r2_agree_hrsanalysis_nonparents_gender)`.
...
apa_table(
  ...
  , landscape = T
  , font_size = "footnotesize"
  , stub_indents = list("LISS (M1a, M1b)" = 1:17, "HRS (M2a, M2b)" = 18:34)
  , placement = "H"
)
```

(ref:H1-agree-gender-contrasts-cap) Linear Contrasts for `r df_outcomes["agree", "maj"]` (Moderated by Gender).
(ref:H1-agree-gender-contrasts-note) The linear contrasts are based on the models from Table \@ref(tab:H1-agree-gender-tab).
...
(ref:H1-agree-work-tab-note) Two models were computed (only HRS): grandparents matched with parent controls (model M2a) and with nonparent controls (model M2b). CI = confidence interval. $R^2_{M2a} =$ `r printnum(r2_agree_hrsanalysis_parents_work)`, $R^2_{M2b} =$ `r printnum(r2_agree_hrsanalysis_nonparents_work)`.
...
(ref:H1-agree-work-contrasts-note) The linear contrasts are based on the models from Table \@ref(tab:H1-agree-work-tab).
...
(ref:H1-agree-care-tab-note) Two models were computed (only HRS): grandparents matched with parent controls (model M2a) and with nonparent controls (model M2b). CI = confidence interval. $R^2_{M2a} =$ `r printnum(r2_agree_hrsanalysis_care_parents)`, $R^2_{M2b} =$ `r printnum(r2_agree_hrsanalysis_care_nonparents)`. $caring=1$ indicates more than 100 hours of grandchild care since the last assessment.
...
(ref:H1-agree-care-contrasts-note) The linear contrasts are based on the models from Table \@ref(tab:H1-agree-care-tab).
...
(ref:H1-con-tab-note) Two models were computed for each of the two samples (LISS, HRS): grandparents matched with parent controls (models MXa) and with nonparent controls (models MXb). CI = confidence interval. $R^2_{M1a} =$ `r printnum(r2_con_lissanalysis_parents)`, $R^2_{M1b} =$ `r printnum(r2_con_lissanalysis_nonparents)`, $R^2_{M2a} =$ `r printnum(r2_con_hrsanalysis_parents)`, $R^2_{M2b} =$ `r printnum(r2_con_hrsanalysis_nonparents)`.
...
(ref:H1-con-contrasts-note) The linear contrasts are needed in cases where estimates of interest are represented by multiple fixed-effects coefficients and are computed using the *linearHypothesis* function from the *car* R package [@car2019] based on the models from Table \@ref(tab:H1-con-tab).
...
(ref:H1-con-gender-tab-note) Two models were computed for each of the two samples (LISS, HRS): grandparents matched with parent controls (models MXa) and with nonparent controls (models MXb). CI = confidence interval. $R^2_{M1a} =$ `r printnum(r2_con_lissanalysis_parents_gender)`, $R^2_{M1b} =$ `r printnum(r2_con_lissanalysis_nonparents_gender)`, $R^2_{M2a} =$ `r printnum(r2_con_hrsanalysis_parents_gender)`, $R^2_{M2b} =$ `r printnum(r2_con_hrsanalysis_nonparents_gender)`.
...
(ref:H1-con-gender-contrasts-note) The linear contrasts are based on the models from Table \@ref(tab:H1-con-gender-tab).
...
(ref:H1-con-work-tab-note) Two models were computed (only HRS): grandparents matched with parent controls (model M2a) and with nonparent controls (model M2b). CI = confidence interval. $R^2_{M2a} =$ `r printnum(r2_con_hrsanalysis_parents_work)`, $R^2_{M2b} =$ `r printnum(r2_con_hrsanalysis_nonparents_work)`.
...
(ref:H1-con-work-contrasts-note) The linear contrasts are based on the models from Table \@ref(tab:H1-con-work-tab).
...
(ref:H1-con-care-tab-note) Two models were computed (only HRS): grandparents matched with parent controls (model M2a) and with nonparent controls (model M2b). CI = confidence interval. $R^2_{M2a} =$ `r printnum(r2_con_hrsanalysis_care_parents)`, $R^2_{M2b} =$ `r printnum(r2_con_hrsanalysis_care_nonparents)`. $caring=1$ indicates more than 100 hours of grandchild care since the last assessment.
...
(ref:H1-con-care-contrasts-note) The linear contrasts are based on the models from Table \@ref(tab:H1-con-care-tab).
...
(ref:H1-extra-tab-note) Two models were computed for each of the two samples (LISS, HRS): grandparents matched with parent controls (models MXa) and with nonparent controls (models MXb). CI = confidence interval. $R^2_{M1a} =$ `r printnum(r2_extra_lissanalysis_parents)`, $R^2_{M1b} =$ `r printnum(r2_extra_lissanalysis_nonparents)`, $R^2_{M2a} =$ `r printnum(r2_extra_hrsanalysis_parents)`, $R^2_{M2b} =$ `r printnum(r2_extra_hrsanalysis_nonparents)`.
...
(ref:H1-extra-contrasts-note) The linear contrasts are needed in cases where estimates of interest are represented by multiple fixed-effects coefficients and are computed using the *linearHypothesis* function from the *car* R package [@car2019] based on the models from Table \@ref(tab:H1-extra-tab).
...
(ref:H1-extra-gender-tab-note) Two models were computed for each of the two samples (LISS, HRS): grandparents matched with parent controls (models MXa) and with nonparent controls (models MXb). CI = confidence interval. $R^2_{M1a} =$ `r printnum(r2_extra_lissanalysis_parents_gender)`, $R^2_{M1b} =$ `r printnum(r2_extra_lissanalysis_nonparents_gender)`, $R^2_{M2a} =$ `r printnum(r2_extra_hrsanalysis_parents_gender)`, $R^2_{M2b} =$ `r printnum(r2_extra_hrsanalysis_nonparents_gender)`.
...
(ref:H1-extra-gender-contrasts-note) The linear contrasts are based on the models from Table \@ref(tab:H1-extra-gender-tab).
...
(ref:H1-extra-work-tab-note) Two models were computed (only HRS): grandparents matched with parent controls (model M2a) and with nonparent controls (model M2b). CI = confidence interval. $R^2_{M2a} =$ `r printnum(r2_extra_hrsanalysis_parents_work)`, $R^2_{M2b} =$ `r printnum(r2_extra_hrsanalysis_nonparents_work)`.
...
(ref:H1-extra-work-contrasts-note) The linear contrasts are based on the models from Table \@ref(tab:H1-extra-work-tab).
...
(ref:H1-extra-care-tab-note) Two models were computed (only HRS): grandparents matched with parent controls (model M2a) and with nonparent controls (model M2b). CI = confidence interval. $R^2_{M2a} =$ `r printnum(r2_extra_hrsanalysis_care_parents)`, $R^2_{M2b} =$ `r printnum(r2_extra_hrsanalysis_care_nonparents)`. $caring=1$ indicates more than 100 hours of grandchild care since the last assessment.
...
(ref:H1-extra-care-contrasts-note) The linear contrasts are based on the models from Table \@ref(tab:H1-extra-care-tab).
...
(ref:H1-neur-tab-note) Two models were computed for each of the two samples (LISS, HRS): grandparents matched with parent controls (models MXa) and with nonparent controls (models MXb). CI = confidence interval. $R^2_{M1a} =$ `r printnum(r2_neur_lissanalysis_parents)`, $R^2_{M1b} =$ `r printnum(r2_neur_lissanalysis_nonparents)`, $R^2_{M2a} =$ `r printnum(r2_neur_hrsanalysis_parents)`, $R^2_{M2b} =$ `r printnum(r2_neur_hrsanalysis_nonparents)`.
...
(ref:H1-neur-contrasts-note) The linear contrasts are needed in cases where estimates of interest are represented by multiple fixed-effects coefficients and are computed using the *linearHypothesis* function from the *car* R package [@car2019] based on the models from Table \@ref(tab:H1-neur-tab).
...
(ref:H1-neur-gender-tab-note) Two models were computed for each of the two samples (LISS, HRS): grandparents matched with parent controls (models MXa) and with nonparent controls (models MXb). CI = confidence interval. $R^2_{M1a} =$ `r printnum(r2_neur_lissanalysis_parents_gender)`, $R^2_{M1b} =$ `r printnum(r2_neur_lissanalysis_nonparents_gender)`, $R^2_{M2a} =$ `r printnum(r2_neur_hrsanalysis_parents_gender)`, $R^2_{M2b} =$ `r printnum(r2_neur_hrsanalysis_nonparents_gender)`.
...
(ref:H1-neur-gender-contrasts-note) The linear contrasts are based on the models from Table \@ref(tab:H1-neur-gender-tab).
...
(ref:H1-neur-work-tab-note) Two models were computed (only HRS): grandparents matched with parent controls (model M2a) and with nonparent controls (model M2b). CI = confidence interval. $R^2_{M2a} =$ `r printnum(r2_neur_hrsanalysis_parents_work)`, $R^2_{M2b} =$ `r printnum(r2_neur_hrsanalysis_nonparents_work)`.
...
(ref:H1-neur-work-contrasts-note) The linear contrasts are based on the models from Table \@ref(tab:H1-neur-work-tab).
...
(ref:H1-neur-care-tab-note) Two models were computed (only HRS): grandparents matched with parent controls (model M2a) and with nonparent controls (model M2b). CI = confidence interval. $R^2_{M2a} =$ `r printnum(r2_neur_hrsanalysis_care_parents)`, $R^2_{M2b} =$ `r printnum(r2_neur_hrsanalysis_care_nonparents)`. $caring=1$ indicates more than 100 hours of grandchild care since the last assessment.
...
(ref:H1-neur-care-contrasts-note) The linear contrasts are based on the models from Table \@ref(tab:H1-neur-care-tab).
...
(ref:H1-open-tab-note) Two models were computed for each of the two samples (LISS, HRS): grandparents matched with parent controls (models MXa) and with nonparent controls (models MXb). CI = confidence interval. $R^2_{M1a} =$ `r printnum(r2_open_lissanalysis_parents)`, $R^2_{M1b} =$ `r printnum(r2_open_lissanalysis_nonparents)`, $R^2_{M2a} =$ `r printnum(r2_open_hrsanalysis_parents)`, $R^2_{M2b} =$ `r printnum(r2_open_hrsanalysis_nonparents)`.
...
(ref:H1-open-contrasts-note) The linear contrasts are needed in cases where estimates of interest are represented by multiple fixed-effects coefficients and are computed using the *linearHypothesis* function from the *car* R package [@car2019] based on the models from Table \@ref(tab:H1-open-tab).
...
(ref:H1-open-gender-tab-note) Two models were computed for each of the two samples (LISS, HRS): grandparents matched with parent controls (models MXa) and with nonparent controls (models MXb). CI = confidence interval. $R^2_{M1a} =$ `r printnum(r2_open_lissanalysis_parents_gender)`, $R^2_{M1b} =$ `r printnum(r2_open_lissanalysis_nonparents_gender)`, $R^2_{M2a} =$ `r printnum(r2_open_hrsanalysis_parents_gender)`, $R^2_{M2b} =$ `r printnum(r2_open_hrsanalysis_nonparents_gender)`.
...
(ref:H1-open-gender-contrasts-note) The linear contrasts are based on the models from Table \@ref(tab:H1-open-gender-tab).
...
(ref:H1-open-work-tab-note) Two models were computed (only HRS): grandparents matched with parent controls (model M2a) and with nonparent controls (model M2b). CI = confidence interval. $R^2_{M2a} =$ `r printnum(r2_open_hrsanalysis_parents_work)`, $R^2_{M2b} =$ `r printnum(r2_open_hrsanalysis_nonparents_work)`.
...
(ref:H1-open-work-contrasts-note) The linear contrasts are based on the models from Table \@ref(tab:H1-open-work-tab).
...
(ref:H1-open-care-tab-note) Two models were computed (only HRS): grandparents matched with parent controls (model M2a) and with nonparent controls (model M2b). CI = confidence interval. $R^2_{M2a} =$ `r printnum(r2_open_hrsanalysis_care_parents)`, $R^2_{M2b} =$ `r printnum(r2_open_hrsanalysis_care_nonparents)`. $caring=1$ indicates more than 100 hours of grandchild care since the last assessment.
...
(ref:H1-open-care-contrasts-note) The linear contrasts are based on the models from Table \@ref(tab:H1-open-care-tab).
...
(ref:H1-swls-tab-note) Two models were computed for each of the two samples (LISS, HRS): grandparents matched with parent controls (models MXa) and with nonparent controls (models MXb). CI = confidence interval. $R^2_{M1a} =$ `r printnum(r2_swls_lissanalysis_parents)`, $R^2_{M1b} =$ `r printnum(r2_swls_lissanalysis_nonparents)`, $R^2_{M2a} =$ `r printnum(r2_swls_hrsanalysis_parents)`, $R^2_{M2b} =$ `r printnum(r2_swls_hrsanalysis_nonparents)`.
...
(ref:H1-swls-contrasts-note) The linear contrasts are needed in cases where estimates of interest are represented by multiple fixed-effects coefficients and are computed using the *linearHypothesis* function from the *car* R package [@car2019] based on the models from Table \@ref(tab:H1-swls-tab).
...
(ref:H1-swls-gender-tab-note) Two models were computed for each of the two samples (LISS, HRS): grandparents matched with parent controls (models MXa) and with nonparent controls (models MXb). CI = confidence interval. $R^2_{M1a} =$ `r printnum(r2_swls_lissanalysis_parents_gender)`, $R^2_{M1b} =$ `r printnum(r2_swls_lissanalysis_nonparents_gender)`, $R^2_{M2a} =$ `r printnum(r2_swls_hrsanalysis_parents_gender)`, $R^2_{M2b} =$ `r printnum(r2_swls_hrsanalysis_nonparents_gender)`.
...
(ref:H1-swls-gender-contrasts-note) The linear contrasts are based on the models from Table \@ref(tab:H1-swls-gender-tab).
...
(ref:H1-swls-work-tab-note) Two models were computed (only HRS): grandparents matched with parent controls (model M2a) and with nonparent controls (model M2b). CI = confidence interval. $R^2_{M2a} =$ `r printnum(r2_swls_hrsanalysis_parents_work)`, $R^2_{M2b} =$ `r printnum(r2_swls_hrsanalysis_nonparents_work)`.
...
(ref:H1-swls-work-contrasts-note) The linear contrasts are based on the models from Table \@ref(tab:H1-swls-work-tab).
...
(ref:H1-swls-care-tab-note) Two models were computed (only HRS): grandparents matched with parent controls (model M2a) and with nonparent controls (model M2b). CI = confidence interval. $R^2_{M2a} =$ `r printnum(r2_swls_hrsanalysis_care_parents)`, $R^2_{M2b} =$ `r printnum(r2_swls_hrsanalysis_care_nonparents)`. $caring=1$ indicates more than 100 hours of grandchild care since the last assessment.
...
(ref:H1-swls-care-contrasts-note) The linear contrasts are based on the models from Table \@ref(tab:H1-swls-care-tab).
