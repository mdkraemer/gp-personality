...
In both samples, we tracked grandparenthood status (0 = *no grandchildren*, 1 = *at least one grandchild*) over time. Due to longitudinally inconsistent data in some cases<!-- report N? -->, we included in the grandparent group only respondents with exactly one transition from 0 to 1 in this status variable, and no transitions backwards (see Fig. \@ref(fig:flowchart-participant)). We marked respondents who continually indicated that they had no grandchildren as potential members of the control groups.  
