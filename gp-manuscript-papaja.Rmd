...
- causal interpretation depends on correctly specified PS model and covariate choice (not all available in archival data; plus we aimed for equivalent sets in both samples) plus no unmeasured confounding; also time-varying influence of covariates not accounted for (-> might be possible in IPTW [@hernanCausalInferenceWhat2020; @thoemmesPrimerInverseProbability2016]) -> but followed recent state-of-the-art recommendations [@vanderweeleOutcomeWideLongitudinalDesigns2020]
